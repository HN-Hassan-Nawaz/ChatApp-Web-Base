...
const WhatsAppClone = () => {
    ...
    useEffect(() => {
        ...
        socket.on("chat message", (msg) => {
            ...
            // Add condition if needed, then push to messages
            if (
                msg.senderId === userId ||
                msg.receiverId === userId
            ) {
                                        ...
                                        >
                                            ...
                                            {msg.isImage ? (
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        className={`mt-1 flex items-center gap-1 text-[11px] ${isSent ? "text-black/60" : "text-gray-500"} justify-end`}
                                                    >
                                                        <span>
                                ...
                                <input
                                    ...
                                    onKeyDown={(e) => {
                                        if (e.key === 'Enter' && input.trim()) {
                                            ...
                                            socketRef.current.emit("chat message", msgData, (response) => {
                                                if (response?.error) {
